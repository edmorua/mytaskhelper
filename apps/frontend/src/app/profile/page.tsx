            ...
            <div className="flex items-center gap-5">
              <div className="relative">
                ...
                {user?.provider === 'google' && (
                  <div className="absolute bottom-0 right-0 h-6 w-6 rounded-full bg-white border-2 border-white shadow flex items-center justify-center">
              ...
              <div>
                ...
                <span className="mt-1.5 inline-flex items-center rounded-full bg-gray-100 px-2 py-0.5 text-xs font-medium text-gray-600 capitalize">
